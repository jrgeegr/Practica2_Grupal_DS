...
abstract class SecretKeeperDecorator implements SecretKeeper {
  final SecretKeeper _envoltorio;
  SecretKeeperDecorator(this._envoltorio);

  @override
  String get secretWord => _envoltorio.secretWord;

  @override
  Future<String> ask(String userMessage) => _envoltorio.ask(userMessage);
}

// --- Decorador: Prompt Estricto ---
class StrongSystemPromptDecorator extends SecretKeeperDecorator {
  StrongSystemPromptDecorator(super.envoltorio);
...
class KeywordBlockDecorator extends SecretKeeperDecorator {
  ...
  KeywordBlockDecorator(super.envoltorio);
...
class LengthLimitDecorator extends SecretKeeperDecorator {
  LengthLimitDecorator(super.envoltorio);
